...
export default class App extends Component {
    ...
    constructor(props) {                        //Conservative way of coding iso class fields
        ...
        this.state = {
            data : [
                {label:'Start to learn React', important: true, like: false, id: 1}, //add id generator
                {label:'React is great!', important: false, like: false, id: 2},
                {label:'So flexible...', important: false, like: false, id: 3}
            ]
        };
